public class AutoParkTester {
    public static void main(String[] args){
        ...
        park.addItem(i5);
        park.addItem(i6);
        Minivan i7 = new Minivan("Ford", "Transit", 2020, "goods",true,22000,10);
        Minivan i8 = new Minivan("Ram", "ProMaster", 2019, "equipment",false,19000,10);
        park.addItem(i7);
        park.addItem(i8);
        ...
        Minivan mysteryVan = new Minivan("Mercedes-Benz", "Sprinter", 2021, "goods", true, 65000,10);
